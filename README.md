...
|  Product                |          PHP version   |     WordPress 4.3      |      WordPress 4.4     |    WordPress 4.5.3     |    WordPress 4.7.2    |    WordPress 4.8.3 |   WordPress 4.9.0   | WordPress 4.9.8| WordPress 5.1 - 5.2.2 |
|         -------         |                ---     |          ---           |         ---            |       ---              |        ---            |      ---           |          ---        |           ---        |           ---        |  
| Store Integrator-2.7.6  | 7.1, 7.2               | EOL                    | EOL                    | EOL                    | ✓ EOL (31 August 2018)| ✓ WooCommerce 3.2.1|  ✓ WooCommerce 3.3.3| ✓ WooCommerce 3.5.1  |✓ WooCommerce 3.6.4 |
| Store Integrator-2.6.4  |5.6, 7.0, 7.1, 7.2      | EOL                    | EOL                    | EOL                    | ✓ EOL (31 August 2018)| ✓ WooCommerce 3.2.1 |  ✓ WooCommerce 3.3.3| ✓ WooCommerce 3.5.1 ( 28 November 2018)|
