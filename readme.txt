...
* Support BOBSI-6 IOException: Premature EOF. Added the option to clean php buffers up on tradefeed download in order to avoid the conflicts with other plugins that use php buffers.
 ...
 * Fixed plugin conflict between the BidorBuy plugin and the Advanced Bulk Edit.

_[Updated on March 20, 2019]_ 

#### 2.6.6

 * Fixed Defect #6209: WooCommerce StoreIntegrator | Uncaught TypeError: Argument 1 passed to BidorbuyStoreIntegratorExport::getProductId() must be an instance of WC_Product, boolean given.
...
* EOL of support WordPress 4.7.x (31 August 2018).
...
#### 2.3.0
* Added GTIN tag.
* Debug section improvements: renaming block.  

_[Updated on April 11, 2018]_
